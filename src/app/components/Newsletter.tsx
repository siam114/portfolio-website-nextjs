          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 md:w-2/3">
                Get the latest updates on my projects and tech insights deliverd
            ...
            <form className="flex flex-col md:flex-row gap-4">
              ...
              <button
                type="submit"
                className="bg-primary text-white px-8 py-3 rounded-lg hover:bg-primary/90 transition-colors cursor-pointer"
              >
                Subscribe
              </button>
            </form>
